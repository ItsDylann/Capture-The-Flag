...
public class ArenaManager {
    ...
    public ArenaManager(Capturetheflag capturetheflag) {

        FileConfiguration config = capturetheflag.getConfig();
        for (String str : config.getConfigurationSection("arenas.").getKeys(false)) {
            arenas.add(new Arena(capturetheflag, Integer.parseInt(str), new Location(
